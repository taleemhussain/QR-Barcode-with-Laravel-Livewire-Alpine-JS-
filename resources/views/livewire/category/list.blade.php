            ...
            <tbody>
                @foreach ($categories as $category)
                    <tr>
                        ...
                        <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                            <p class="text-black dark:text-white">@if($category->status) Active @else Inactive @endif</p>
                        </td>
                        <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        <div class="flex items-center space-x-3.5">
                            <button class="hover:text-primary" wire:click="editCategory({{ $category->id }})">
                            ...
                            <button class="hover:text-primary" wire:click="showConfirmation({{ $category->id }})">
                                <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
            ...
            <div style="background-color: rgba(0, 0, 0, .5)" class="mx-auto absolute top-0 left-0 w-full h-full flex items-center shadow-lg overflow-y-auto">
                <div class="container mx-auto rounded p-4 mt-2 overflow-y-auto w-full xl:w-1/2">
                    <div class="bg-white rounded px-8 py-8">
                        ...
                        @endif
                        <h1 class="font-bold text-2xl mb-3">Edit Category</h1>
                        <div class="modal-body">
