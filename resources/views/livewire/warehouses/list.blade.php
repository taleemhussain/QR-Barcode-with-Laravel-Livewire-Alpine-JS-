                        ...
                        <div style="background-color: rgba(0, 0, 0, .5)" class="mx-auto absolute top-0 left-0 w-full h-full flex items-center shadow-lg overflow-y-auto" x-show="isOpen">
                            <div class="container mx-auto rounded p-4 mt-2 overflow-y-auto w-full xl:w-1/2">
                                <div class="bg-white rounded px-8 py-8">
                                    ...
                                    @endif
                                    <h1 class="font-bold text-2xl mb-3">Warehouse</h1>
                ...
                @foreach ($warehouses as $warehouse)
                    <tr>
                        <td class="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                            <p class="text-sm">{{$warehouse->id}}</p>
                        </td>
                        <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                            <p class="text-black dark:text-white">{{$warehouse->title}}</p>
                        </td>
                        <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                            <p class="text-black dark:text-white">@if($warehouse->status) Active @else Inactive @endif</p>
                        </td>
                        <td class="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        <div class="flex items-center space-x-3.5">
                            <button class="hover:text-primary" wire:click="editCategory({{ $warehouse->id }})">
                            ...
                            <button class="hover:text-primary" wire:click="showConfirmation({{ $warehouse->id }})">
                                <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
            ...
            <div style="background-color: rgba(0, 0, 0, .5)" class="mx-auto absolute top-0 left-0 w-full h-full flex items-center shadow-lg overflow-y-auto">
                <div class="container mx-auto rounded p-4 mt-2 overflow-y-auto w-full xl:w-1/2">
                    <div class="bg-white rounded px-8 py-8">
                        ...
                        @endif
                        <h1 class="font-bold text-2xl mb-3">Edit warehouse</h1>
                        <div class="modal-body">
                            <form wire:submit.prevent="edit">
                                <div class="p-6.5">
                                  <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                    ...
                                    <a  href="javascript:void(0)" wire:click="closeModel()" class="inline-flex items-center justify-center rounded-md border border-primary py-4 px-10 text-center font-medium text-primary hover:bg-opacity-90 lg:px-8 xl:px-10">
                                        Close
                                    </a>
                                </div>
                            </form>
